...
mul_times=1
# model_tag="Qwen3-4B-mix_en_fi_normal_mix"
model_tag="Qwen3-4B-mix_en_fi_dynmic_mode"
...
# train_file_path="[$dir/train/wmt_en2fi_7k.parquet,$dir/train/Qwen3-4B_en-fi_FI.parquet]"
