...
mul_times=1
model_tag="Qwen3-8B-all-main-ours"
exp_name="shenyz_bs@${train_batch_size}_n@${rollout_num}_m@${mul_times}_@${datetime}_@${model_tag}_@${num_gpus}gpus"
dir=./data

train_file_path="[$dir/train/train_mixed_en-zh_CN.parquet,$dir/train/wmt_en2fi_7k.parquet,$dir/train/wmt_en2tr_6k.parquet]"
test_file_path="[$dir/test/wmt24_en-zh_CN.parquet,$dir/test/challenge_set_en-zh_CN.parquet,$dir/test/flores_en2zh.parquet,$dir/test/wmt24_en-fi_FI.parquet,$dir/test/flores_en2fi.parquet,$dir/test/wmt24_en-tr_TR.parquet,$dir/test/flores_en2tr.parquet]"
