...
ppo_mini_batch_size=64 # 大显存(140G)或许可以改成 128
ppo_micro_batch_size_per_gpu=16 # 大显存(140G)或许可以改成 64
project_name="shenyz"
save_freq=50
